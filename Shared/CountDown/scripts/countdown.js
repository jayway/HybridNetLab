...
var note = "Hoverboard time!";	/* -->Enter what you want the script to
...
var minute = 29;      /* -->Enter the count down target date MINUTE */
var tz = +1;          /* -->Offset for your timezone in hours from UTC (see
